...
**If you got 4–5 right:** you arrive with the platform priors this book assumes. Read Chapters 2 and 3 at normal pace. The calibration in §6 will point you toward the chapters where your real gaps are. They are probably not where you expect.
...
Here is a question worth carrying for the next few pages: **why does most of the KCNA study material online describe a different exam than the one you are going to sit?**

Not a slightly different exam. A structurally different one: a different number of domains, different weights, and one whole domain that no longer exists. The material isn't fraudulent and its authors aren't careless. Something moved underneath them, and most haven't caught up. Section 3 has the details. By the end of this chapter you'll be able to spot a stale guide yourself, in about fifteen seconds of skimming.

First, the credential itself.

The **Kubernetes and Cloud Native Associate**, the KCNA, is the entry point to the cloud native certification family. The Linux Foundation, which administers it on behalf of the CNCF, describes it as demonstrating "a user's foundational knowledge and skills in Kubernetes and the wider cloud native ecosystem" [source: lf-kcna-exam-page-2026-08-23]. Experience level: beginner. Prerequisites: none [source: lf-kcna-exam-page-2026-08-23].
...
Now the disclosure that separates this book from most of its competitors.
...
You will nonetheless see "60 questions, 75% to pass" repeated across dozens of study sites, videos, and forum threads, usually stated flatly, as fact. Those figures are widely and consistently reported by third parties. They are also, at the time of writing, not published by the certifying body [source: lf-kcna-exam-page-2026-08-23].
...
**Cloud Native Application Delivery doubled**, from 8% to 16% [source: lf-kcna-program-changes-2026-08-23]. This is the single largest proportional change in the restructure, and it's the one most third-party material serves worst. When a topic was 8% of the exam, most guides gave it a thin chapter, and doubling the weight doesn't retroactively thicken that chapter. GitOps, Helm, deployment strategies, debugging deployed applications: this is now one exam question in six. *[cross-bearing: see Ch 14–16 — the Application Delivery domain in full]*
...
- **A is wrong**, and it's the trap that matters. Cloud Native Observability *was* a standalone 8% domain, in the blueprint retired in November 2025. If you picked A, you may be studying from the old chart, or thinking in its terms. That's the whole point of §3.
...
You've read "cloud native" perhaps a dozen times by now. It's in the credential's name. It's in three of the four domain names. And I haven't defined it.
...
The CNCF maintains a published definition with named characteristics. You will get it in full in Chapter 17: the actual document, unabridged, each characteristic examined. *[cross-bearing: see Ch 17 §1 — the CNCF cloud native definition and its characteristics]*
...
>
> They'd done everything right by their own lights: worked through the whole course, drilled the practice sets, built a mental map of the exam. That map had five domains on it. It had a standalone observability domain worth 8%, and they had studied Prometheus with the thoroughness an 8% standalone domain deserves. They knew the exporters. They knew the scrape model. They could talk about PromQL.
>
...
That is not decoration, and it is not a metaphor chosen for the scenery. The intermodal shipping container changed global trade not by being a better box, but by being a box that every crane, truck bed, railcar, and ship's hold in the world agreed to handle identically. The contents stopped mattering to the infrastructure. That one decoupling, between what's inside and what moves it, is precisely what a software container does, and it's why Chapter 2 starts there rather than with a definition.
