...
**CORRECTION 2026-08-24:** the §3 numbering warning above is stale — chapter-04's re-draft (commit `73fd066`) dropped the §-numbers from all three of its Ch 6 pointers, so §3 is no longer pinned by chapter-04. The ch01:436 (→§6) and ch02:600 (→§8) retargets have been applied in shipped text.
