...
There is also a shift in who you are while you use them. Chapter 13's reader was interrogating somebody else's platform from the outside, asking whether the cluster had done its job. This chapter's reader is the person who shipped the thing — working inside a cluster they do not own, with permissions they did not grant themselves, on an image that may not contain a shell. That is the actual posture of an application engineer on Kubernetes, and it is what the chapter title names.
